 ...
 * Revoke Stash
 */
export const revokeStashApiV1StashesSlugDelete = <ThrowOnError extends boolean = false>(options: Options<RevokeStashApiV1StashesSlugDeleteData, ThrowOnError>): RequestResult<RevokeStashApiV1StashesSlugDeleteResponses, RevokeStashApiV1StashesSlugDeleteErrors, ThrowOnError> => (options.client ?? client).delete<RevokeStashApiV1StashesSlugDeleteResponses, RevokeStashApiV1StashesSlugDeleteErrors, ThrowOnError>({ url: '/api/v1/stashes/{slug}', ...options });
 ...
 * Get Active Ip Ban
 */
export const getActiveIpBanApiV1IpIpAddrBansActiveGet = <ThrowOnError extends boolean = false>(options: Options<GetActiveIpBanApiV1IpIpAddrBansActiveGetData, ThrowOnError>): RequestResult<GetActiveIpBanApiV1IpIpAddrBansActiveGetResponses, GetActiveIpBanApiV1IpIpAddrBansActiveGetErrors, ThrowOnError> => (options.client ?? client).get<GetActiveIpBanApiV1IpIpAddrBansActiveGetResponses, GetActiveIpBanApiV1IpIpAddrBansActiveGetErrors, ThrowOnError>({ url: '/api/v1/ip/{ip_addr}/bans/active', ...options });
